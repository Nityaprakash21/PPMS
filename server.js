...
app.use(session({
  ...
  app.post('/submit', async (req, res) => {
    ...
    if (!req.body.tankid || !req.body.tankfuel || !req.body.tankcapacity || !req.body.optimumvolume  || !req.body.tankname  || !req.body.minimumvolume  || !req.body.machineid  || !req.body.machinename  || !req.body.dispensingunitnumber ) {
      console.log('Missing required fields in request body');
      return res.status(400).send('Missing required fields in request body');
    }

    const { tankid, tankfuel, tankcapacity, optimumvolume, tankname, minimumvolume, machineid, machinename, dispensingunitnumber } = req.body;
    const tankData = {
      tank_id: tankid,
      tank_fuel: tankfuel,
